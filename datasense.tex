...
\begin{enumerate}
    \item Small curated dataset (≈120 examples) focused on business and reporting queries.
    \item Automated training via the included script; prepares dependencies and builds a compact LoRA adapter.
    \item Improves domain-specific accuracy while remaining fast to run and easy to deploy.
\end{enumerate}
