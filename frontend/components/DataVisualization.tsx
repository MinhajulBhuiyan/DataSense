  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-green-700 transition-colors border border-green-600 shadow-sm bg-green-600 text-white hover:shadow-md"
